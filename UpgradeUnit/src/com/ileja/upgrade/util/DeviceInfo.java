...
/**
 * Helper class for accessing hardware specifications, including the number of
 * CPU cores, CPU clock speed and total available RAM.
 */
public class DeviceInfo {

	/**
	 * The default return value of any method in this class when an error occurs
	 * or when processing fails (Currently set to -1). Use this to check if the
	 * information about the device in question was successfully obtained.
	 */
	 ...
	 *
	 * @return Number of CPU cores in the phone, or DEVICEINFO_UKNOWN = -1 in
	...
	/**
	 * Method for reading the clock speed of a CPU core on the device. Will read
	 * from either {@code /sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_max_freq}
	 * or {@code /proc/cpuinfo}.
	 *
	 * @return Clock speed of a core on the device, or -1 in the event of an
	 *         error.
	 */
	...
	/**
	 * Calculates the total RAM of the device through Android API or
	 * /proc/meminfo.
	 *
	 * @param c
	 *            - Context object for current running activity.
	 * @return Total RAM that the device has, or DEVICEINFO_UNKNOWN = -1 in the
	 *         event of an error.
	 */
